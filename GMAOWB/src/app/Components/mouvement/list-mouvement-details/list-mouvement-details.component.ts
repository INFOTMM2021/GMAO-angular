...
@Component({
  selector: 'app-list-mouvement-details',
  templateUrl: './list-mouvement-details.component.html',
  styleUrls: ['./list-mouvement-details.component.css']
})
export class ListMouvementDetailsComponent implements OnInit {
  ...
  Reguler(item :MouvementDetail){
    this.router.navigate(['/regulStock'], {state: {item: item}});
  }
}
